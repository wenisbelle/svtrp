#include "custom_nav2_costmap_plugin/moving_costmap.hpp"
...
CustomMovingCostmap::CustomMovingCostmap()
...
void
CustomMovingCostmap::onInitialize()
{
...
void
CustomMovingCostmap::updateBounds(
...
void
CustomMovingCostmap::onFootprintChanged()
{
  need_recalculation_ = true;

  RCLCPP_DEBUG(rclcpp::get_logger(
      "nav2_costmap_2d"), "CustomMovingCostmap::onFootprintChanged(): num footprint points: %lu",
...
void
CustomMovingCostmap::updateCosts(
...
bool
CustomMovingCostmap::pointInsideCircle(int x_point, int y_point)
{
...
// This is the macro allowing a my_custom_costmap_namespace_name::CustomMovingCostmap class
// to be registered in order to be dynamically loadable of base type nav2_costmap_2d::Layer.
// Usually places in the end of cpp-file where the loadable class written.
#include "pluginlib/class_list_macros.hpp"
PLUGINLIB_EXPORT_CLASS(custom_moving_costmap::CustomMovingCostmap, nav2_costmap_2d::Layer)